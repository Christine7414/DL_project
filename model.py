...
class ARC(nn.Module) :
    def __init__(self):
        ...
        self.TConv4 = nn.ConvTranspose1d(256, 512, 3, 2)
        self.Bn4 = nn.BatchNorm1d(512)
        self.TConv5 = nn.ConvTranspose1d(512, 1024, 3, 2)
        self.Bn5 = nn.BatchNorm1d(1024)
        self.Conv6 = nn.Conv1d(1024, 4*1025, 3, 1, padding = 2)
        self.gru1 = nn.GRU(215, 215, batch_first = True)
        self.gru2 = nn.GRU(107, 107, batch_first = True)
    def forward(self, x) :
        bs = x.shape[0]
        x = self.Conv1(x)
